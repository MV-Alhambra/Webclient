...
function togglebuildingrules(){
    ...
    if(selected.innerHTML === "▼"){
        ...
        <li>You must be able to reach each new building tile <strong>"on foot"</strong> from the starting tile without crossing a wall and without going off the tiles.</li>
...
function toggle2playerrules(){
    ...
    <ul>
        ...
        <li>There is an <strong>imaginary third player.</strong> Let's call him Dirk. Dirk does not build an Alhambra but <strong>does collect building tiles.</strong> Dirk does not have any turns.</li>
        <li><strong>At the beginning of the game 6 building tiles are drawn randomly from the bag</strong> and put to one side for Dirk - in full view of both players.</li>
        <li><strong>In the scoring rounds DIrk is awarded points for having the most of any of the different kinds of building</strong> but <strong>not</strong> for having an external wall.</li>
        ...
        <li>After the <strong>2<sup>nd</sup> scoring round Dirk is given more building tiles.</strong> This time he is not necessarily given 6 but is instead given a <strong>third of the tiles remaining in the bag (rounded down)</strong>.</li>
        <li>Only one rule is different for the two players: whenever they buy a building tile they can not only add it to their Alhambra or place it on their reserve board; they can also give the building tile to Dirk.</li>
    </ul>`
    }
}